...
----local mod = DBM:NewMod("z2610", "DBM-Premades", 2)
----local bgzone = false
...
--	if (GeneralHelper.IsInsidePvpZone())  then
...
--function mod:CHAT_MSG_MONSTER_YELL(message, sender)
--	if not bgzone then return end
